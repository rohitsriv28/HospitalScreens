...
fun TableComponentEHS() {
    ...
    Column(
        Modifier
            .fillMaxSize()) {
        Card(Modifier.padding(0.dp, 16.dp, 0.dp, 0.dp),
            colors = CardDefaults.cardColors(Color(0, 188, 212, 30))) {
            Column(Modifier.horizontalScroll(rememberScrollState())) {
                Text(text = "EHS", modifier = Modifier.padding(12.dp, 8.dp,0.dp,8.dp)
...
/*
            repeat(5){
                Row {
                    Text(text = "1", modifier = Modifier.padding(8.dp))
                    Text(text = "123", modifier = Modifier.padding(8.dp))
                    Text(text = "14", modifier = Modifier.padding(8.dp))
                    Text(text = "Thanos", modifier = Modifier.padding(8.dp))
                    Text(text = "Titan", modifier = Modifier.padding(8.dp))
                    Text(text = "Dead", modifier = Modifier.padding(8.dp))
                }
            }*/
